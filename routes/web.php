    ...
    Route::group(['prefix' => 'admincp'], function (){
        ...
        Route::group(['prefix' => 'dashboard', 'middleware' => ['CheckLogedOut', 'CheckLevel']], function (){
            ...
            Route::group(['prefix' => 'bill'], function (){
                ...
                Route::get('edit/{bill_id}', 'BillController@getEditBill');
                Route::post('edit/{bill_id}', 'BillController@postEditBill');

                Route::get('delete/{bill_id}', 'BillController@getDelBill');
            });
