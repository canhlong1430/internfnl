                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <select required class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" name="method" title="Phương thức thanh toán">
                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    @foreach($product as $products)
                                        <tr>
                                            ...
                                            <td class="text-right">{{number_format($products->product_price)}} VNĐ</td>
                                            <td class="text-center">{{$products->detail_qty}}</td>
                                            <td class="text-right">{{number_format($products->detail_subtotal)}} VNĐ</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
